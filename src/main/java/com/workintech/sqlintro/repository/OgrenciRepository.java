...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_6 = "SELECT * FROM ogrenci ORDER BY ad"; //asc yazmasakta olurdu defaultu zaten asc, alfabenin tersine ise desc!!
    ...
    String QUESTION_8 = "select * from ogrenci order by dtarih desc limit 1;"; //desc ile sıraladık ve limit ile tek birini seçtik
